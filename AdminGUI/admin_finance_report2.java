 ...
 * @author acer
 */
public class admin_finance_report2 extends javax.swing.JFrame {

    /**
     * Creates new form admin_finance_report2
     */
    public admin_finance_report2() {
        initComponents();
    }
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        String status = jTable1.getValueAt(selected_row,4).toString();
        if (!status.equals("Unpaid")){
            JOptionPane.showMessageDialog(null, "Cannot proceed payment for a order that haven't receive", "Warning", JOptionPane.WARNING_MESSAGE);
            return;
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(admin_finance_report2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new admin_finance_report2().setVisible(true);
            }
        });
    }
